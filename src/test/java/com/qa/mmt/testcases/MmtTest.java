...
public class MmtTest extends Base {
	...
	/**
	 * Method to verify the title of Search Page
	 */
	@Test(priority = 1)
	...
	/**
	 * Method to verify the total count of Departure and Return Flights on Page load
	 */
	@Test(priority = 2)
	public void countFlightsTest() {
		extentTest = extent.startTest("countFlightsTest");
		mmtSearchPage.gotoSearchPage();
		// For step 6
	...
	/**
	 * Method to verify the total count of Departure and Return Flights for Non Stop
	 */
	@Test(priority = 3)
	public void countFlightsNonStopTest() {
		extentTest = extent.startTest("countFlightsNonStopTest");
		mmtSearchPage.gotoSearchPage();
		// For step 7
	...
	/**
	 * Method to verify the total count of Departure and Return Flights for One Stop
	 */
	@Test(priority = 4)
	public void countFlightsOneStopTest() {
		extentTest = extent.startTest("countFlightsOneStopTest");
		mmtSearchPage.gotoSearchPage();
	...
	/**
	 * Method to verify Price
	 */
	@Test(priority = 5)
	public void verifyPriceTest() {
		extentTest = extent.startTest("verifyPriceTest");
		mmtSearchPage.gotoSearchPage();
		// For step 8, 9
	...
	/**
	 * Method to verify Sum of Price with total Price
	 */
	@Test(priority = 6)
	public void checkSumWithTotalTest() {
		extentTest = extent.startTest("checkSumWithTotalTest");
		mmtSearchPage.gotoSearchPage();
		// For step 10
